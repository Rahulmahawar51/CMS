       ...
       <?php require_once('inc/nav.php'); ?>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Profile</h1><hr>
                    <ol class="breadcrumb">
                        <li><a href=""><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a></li>          
                        <li class="active"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Profile</li>          
                    </ol>
                    <?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(empty($fname) or empty($lname) or empty($image)){
                            ...
                            $update_query="UPDATE user SET first_name= '$fname', last_name= '$lname', image= '$image', details= '$details' ";
                            if(isset($pass)){
                            ...
                            if(mysqli_query($conn, $update_query)){
                                ...
                                header("refresh:0; url=edit-profile.php?edit=$e_id");
